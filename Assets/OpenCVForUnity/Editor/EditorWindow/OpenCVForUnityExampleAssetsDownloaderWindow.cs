...
namespace OpenCVForUnity.Editor
{
    ...
    public class OpenCVForUnityExampleAssetsDownloaderWindow : EditorWindow
    {
        ...
        static Dictionary<string, string>[] files = {
            ...
            //ObjectDetectionYOLOv7Example
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "ObjectDetectionYOLOv7Example" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/person.jpg" } , { "filename", "person.jpg" }, { "sha", "19281b65c5bd43381dfe04e637e78d0cf0b05cbe" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "ObjectDetectionYOLOv7Example" }, { "url", "https://raw.githubusercontent.com/AlexeyAB/darknet/0faed3e60e52f742bbef43b83f6be51dd30f373e/cfg/yolov7-tiny.cfg" } , { "filename", "yolov7-tiny.cfg" }, { "sha", "883a74987b2a4a8e725b2929826d09a1250373b6" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "ObjectDetectionYOLOv7Example" }, { "url", "https://github.com/AlexeyAB/darknet/releases/download/yolov4/yolov7-tiny.weights" } , { "filename", "yolov7-tiny.weights" }, { "sha", "f3212b63af4764b67da6155f4950567f2183556b" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "ObjectDetectionYOLOv7Example" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/coco.names" } , { "filename", "coco.names" }, { "sha", "b769c7d769385f7640be484dd9c7537b6fb2f35e" } },
